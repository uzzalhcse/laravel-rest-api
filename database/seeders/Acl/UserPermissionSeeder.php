    ...
    public function run()
    {
        ...
        DB::table('user_permissions')->insert(
            [
                ...
                ['user_id'=>3, 'permission_id'=>14, 'created_at'=>$timestamp, 'updated_at'=>$timestamp],
                ['user_id'=>3, 'permission_id'=>15, 'created_at'=>$timestamp, 'updated_at'=>$timestamp],
                ['user_id'=>3, 'permission_id'=>16, 'created_at'=>$timestamp, 'updated_at'=>$timestamp],
                ['user_id'=>3, 'permission_id'=>17, 'created_at'=>$timestamp, 'updated_at'=>$timestamp],

                ['user_id'=>4, 'permission_id'=>14, 'created_at'=>$timestamp, 'updated_at'=>$timestamp],
                ['user_id'=>4, 'permission_id'=>15, 'created_at'=>$timestamp, 'updated_at'=>$timestamp],
                ['user_id'=>4, 'permission_id'=>16, 'created_at'=>$timestamp, 'updated_at'=>$timestamp],
                ['user_id'=>4, 'permission_id'=>17, 'created_at'=>$timestamp, 'updated_at'=>$timestamp],

                ['user_id'=>5, 'permission_id'=>14, 'created_at'=>$timestamp, 'updated_at'=>$timestamp],
